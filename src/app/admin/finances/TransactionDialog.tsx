    ...
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent showCloseButton={false} className="p-0 border-none bg-transparent shadow-none sm:max-w-xl gap-0 outline-none">
          ...
          <div className="bg-[var(--surface)] w-full max-w-xl rounded-2xl shadow-2xl border border-border/50 overflow-hidden relative">
            ...
            <div className="relative p-6 px-7 flex justify-between items-center border-b border-border/20 z-10">
              ...
              <button type="button" onClick={() => setIsOpen(false)} className="text-[var(--text-muted)] hover:text-slate-700 dark:text-slate-200 transition-colors bg-slate-100 dark:bg-slate-800 p-2 rounded-full shadow-sm">
