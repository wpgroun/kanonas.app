  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mt-4">
      ...
      <div className="col-span-1 lg:col-span-8 flex flex-col gap-6">
         ...
         <div className="bg-emerald-50 dark:bg-emerald-950/20 rounded-xl border border-emerald-100 dark:border-emerald-900 overflow-hidden">
            <h3 className="flex items-center gap-2 p-3 px-4 bg-emerald-100/50 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-400 font-bold border-b border-emerald-100 dark:border-emerald-900">
         ...
         <div className="bg-rose-50 dark:bg-rose-950/20 rounded-xl border border-rose-100 dark:border-rose-900 overflow-hidden">
            <h3 className="flex items-center gap-2 p-3 px-4 bg-rose-100/50 dark:bg-rose-900/30 text-rose-800 dark:text-rose-400 font-bold border-b border-rose-100 dark:border-rose-900">
