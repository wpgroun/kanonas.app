...
export default function QuarterlyWidget() {
 ...
 <h3 className="text-sm font-black text-[var(--brand)] uppercase tracking-wider mb-1">Πληρωμή & Εκκαθάριση</h3>
 <h2 className="text-xl font-bold text-[var(--foreground)] mb-4">Εργασίες Τριμήνου</h2>
 
 {status === 'DONE' ? (
 <div className="flex items-center gap-3 text-[var(--success)] bg-[var(--success-light)] p-4 rounded-xl border border-[var(--success)]/20">
