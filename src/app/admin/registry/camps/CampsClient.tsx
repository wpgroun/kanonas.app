  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="space-y-3">
             ...
             {initialCamps.map((camp: any) => (
                <div 
                   ...
                   className={`p-4 rounded-xl cursor-pointer border transition-all ${activeCampId === camp.id ? 'bg-emerald-50 border-emerald-300 dark:bg-emerald-900/30 dark:border-emerald-700 shadow-sm' : 'bg-white dark:bg-gray-900 border-border hover:shadow-md'}`}
                >
       ...
       <div className="flex-1">
          {!activeCamp ? (
             <div className="bg-slate-50 dark:bg-gray-900 border-2 border-dashed border-border rounded-xl h-96 flex flex-col items-center justify-center text-gray-400">
             ...
             <Card className="rounded-xl border-border shadow-sm overflow-hidden flex flex-col min-h-[500px]">
                ...
                <div className="p-4 border-b border-border bg-slate-50 dark:bg-slate-800/50 flex justify-between items-center">
                   <h3 className="font-bold text-gray-700 dark:text-gray-200">Λίστα Παιδιών ({activeCamp.registrations.length})</h3>
                ...
                <div className="p-0 overflow-auto">
                   <table className="w-full text-sm text-left">
                      <thead className="bg-white dark:bg-gray-900 text-gray-600 border-b border-border">
                         <tr>
                      ...
                      <tbody className="divide-y divide-border">
                         {activeCamp.registrations.length === 0 ? (
                            ...
                            <tr key={reg.id} className="hover:bg-slate-50 dark:hover:bg-slate-800">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
             <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl w-full max-w-md p-6">
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                   <div className="p-3 bg-blue-50 dark:bg-blue-900/30 rounded-lg text-sm text-blue-800 border border-blue-200">
