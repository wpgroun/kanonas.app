...
export default function AssetsClient({ initialAssets, currentOwner, currentType }: any) {
  ...
  return (
    <div className="space-y-6">
       {/* Filters */}
       <div className="flex flex-col md:flex-row justify-between bg-white dark:bg-gray-900 p-4 rounded-xl border border-border shadow-sm gap-4">
          ...
          {initialAssets.map((ast: any) => (
             <Card key={ast.id} className="relative overflow-hidden p-0 border border-border hover:shadow-md transition-shadow group flex flex-col h-full">
                {ast.imageUrl ? (
                   ...
                   <div className="h-32 w-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-300">
                ...
                <div className="p-4 flex flex-col flex-grow">
                   ...
                   <div className="mt-auto space-y-2 bg-slate-50 dark:bg-slate-900/50 p-3 rounded-lg border border-border/50">
                      {ast.location && (
