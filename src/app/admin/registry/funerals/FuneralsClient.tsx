       ...
       <div className="w-full lg:w-80 flex flex-col space-y-4">
          ...
          <div className="space-y-3 overflow-y-auto max-h-[600px] pb-4">
               ...
               {filteredDeceased.map((dec: any) => (
                  ...
                  >
                     <h3 className="font-bold text-gray-900 dark:text-white truncate" title={`${dec.lastName} ${dec.firstName}`}>{dec.lastName} {dec.firstName}</h3>
       ...
       {isRegisterModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
             <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                <div className="sticky top-0 bg-white dark:bg-slate-900 border-b border-border p-5 z-10 flex justify-between items-center">
