    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in duration-300">
      ...
      <div className="col-span-1 lg:col-span-2 space-y-4">
         {initialEvents.length === 0 && (
            <Card className="shadow-inner border-dashed border-2 bg-slate-50 dark:bg-slate-900 text-center py-16">
           ...
           {initialEvents.map(ev => {
             ...
             return (
               <Card key={ev.id} className="shadow-lg border-0 overflow-hidden relative transition-transform hover:-translate-y-1 hover:shadow-xl">
                 ...
                 <CardContent className="p-5 pl-8 flex justify-between items-center bg-white dark:bg-slate-900">
                   <div>
                      ...
                      <h3 className="text-xl font-bold text-slate-800 dark:text-white capitalize">{ev.title}</h3>
      ...
      <div className="col-span-1">
        <Card className="shadow-2xl border-0 bg-white dark:bg-slate-900 sticky top-6 rounded-2xl overflow-hidden">
