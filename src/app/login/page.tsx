...
export default function LoginPage() {
 ...
 <h1 className="text-2xl font-bold text-[var(--foreground)] mb-1">{step === 1 ? 'Σύνδεση' : 'Επαλήθευση Σύνδεσης'}</h1>
 <p className="text-sm text-[var(--text-muted)]">{step === 1 ? 'Εισάγετε τα στοιχεία του λογαριασμού σας' : 'Εισάγετε τον 6-ψήφιο κωδικό από το email σας.'}</p>
 </div>
