export const JURISDICTIONS = [
  ...
  {
    label: "Υπαγόμενες στο Οικουμενικό Πατριαρχείο (Δωδεκάνησα)",
    metropolises: [
  ...
  {
    label: "Επαρχίες Εξωτερικού & Διασποράς",
    metropolises: [
