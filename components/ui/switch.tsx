...
const switchVariants = cva(
  `
    ...
    aria-invalid:border aria-invalid:border-destructive/60 aria-invalid:ring-destructive/10 :border-destructive :ring-destructive/20
    [[data-invalid=true]_&]:border [[data-invalid=true]_&]:border-destructive/60 [[data-invalid=true]_&]:ring-destructive/10  =true]_&]:border-destructive =true]_&]:ring-destructive/20
  `,
  {
    variants: {
      shape: {
